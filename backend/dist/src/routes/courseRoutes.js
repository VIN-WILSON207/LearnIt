...
// Routes
router.get('/', courseController_1.getAllCourses); // Public
router.post('/', auth_1.authenticate, (0, auth_1.authorize)('INSTRUCTOR', 'ADMIN'), courseController_1.createCourse);
router.post('/lesson', auth_1.authenticate, (0, auth_1.authorize)('INSTRUCTOR', 'ADMIN'), upload_1.default.single('video'), courseController_1.uploadLesson); // 'video' is the field name
