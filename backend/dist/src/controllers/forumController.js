...
exports.addComment = exports.getForumReports = exports.getPostsQuery = exports.getPosts = exports.createPost = void 0;
...
const getPostsQuery = async (req, res) => {
    try {
        const { courseId, id } = req.query;
        if (id) {
            const post = await prisma_1.default.forumPost.findUnique({
                where: { id: String(id) },
                include: {
...
exports.getForumReports = getForumReports;
